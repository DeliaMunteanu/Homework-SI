...
const mercedesFleet = new CarFleet(20, `Merecedes-Benz`, `Grey`);

const kawasakiFleet = new MotoFleet(10, `Kawasaki`, `Blue`);

console.log(mercedesFleet, kawasakiFleet);
